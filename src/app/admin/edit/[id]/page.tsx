...
export default function EditNotebook() {
  ...
  if (fetching) return <div className="min-h-screen bg-black text-white flex items-center justify-center">Yükleniyor...</div>;
    ...
    <div className="min-h-screen bg-[#050505] text-white p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-12">
          <h1 className="text-4xl font-extrabold tracking-tight mb-2">Kaydı Düzenle</h1>
          <p className="text-slate-500">Mevcut notebook verilerini güncelleyin.</p>
        </header>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, historyYear: parseInt(e.target.value) })}
                  className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all decoration-inherit"
                />
              </div>
            </div>
